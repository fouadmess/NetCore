...
namespace Messaia.Net.Api
{
    ...
    public class ObserveAttribute : Attribute, IActionFilter
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="ObserveAttribute"/> class.
        /// </summary>
        public ObserveAttribute(Type serviceType)
        {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            var observer = context.HttpContext?.RequestServices?.GetService(this.ServiceType);
            if (observer != null)
            {
                ...
                service
                    ...
                    .Invoke(service, new object[] { observer });
            }
        }
