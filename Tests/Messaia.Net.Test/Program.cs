...
namespace Messaia.Net.Test
{
    class Program
    {
        ...
        {
            //var ui = typeof(IUserService);
            //var tt2 = ui.GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.FlattenHierarchy);
            //var g = ui.GetMethod("Subscribe", BindingFlags.Public | BindingFlags.Instance | BindingFlags.FlattenHierarchy,
            //    Type.DefaultBinder,
            //    new Type[] { typeof(IObserver<ICommand>) }, null);

            //var dm = ui.GetMethods(BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.Instance);

            //var map = ui.GetInterfaceMap(interfaceMethod.DeclaringType);
