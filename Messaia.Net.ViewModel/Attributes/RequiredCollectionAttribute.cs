...
namespace Messaia.Net.ViewModel
{
    ...
    /// <summary>
    /// RequiredCollectionAttribute class.
    /// </summary>
    [AttributeUsage(AttributeTargets.Property, AllowMultiple = false)]
    public sealed class RequiredCollectionAttribute : SelfContainedValidationAttribute
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="RequiredCollectionAttribute"/> class.
        /// </summary>
        public RequiredCollectionAttribute() : this(1) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredCollectionAttribute"/> class.
        /// </summary>
        /// <param name="count">The count required.</param>
        public RequiredCollectionAttribute(int count)
        {
            this.Count = count;
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (!(value is IEnumerable collection) || ((ICollection)collection).Count < this.Count)
            {
